...
const CardPrato = styled.div`
  ...
  img { width: 100%; height: 167px; object-fit: cover; }
  h3 { margin: 8px 0; font-size: 16px; font-weight: 900; }
  p { font-size: 14px; line-height: 22px; margin-bottom: 8px; }
  button { 
    width: 100%; 
...
export default function Perfil() {
  ...
  if (!restaurante) return <div style={{background: colors.background, height: '100vh', color: colors.primary}}>Carregando...</div>;
    ...
    <div style={{ backgroundColor: colors.background, minHeight: '100vh' }}>
      ...
      <Banner img={restaurante.capa}>
        <div className="container">
          <p style={{ fontSize: '24px', fontWeight: 300, marginBottom: '12px' }}>{restaurante.tipo}</p>
